...
export const taskbarTheme = defineStyleConfig({
	baseStyle: (props) => ({
		...
		py: '0.175rem',
		px: 4,
		background: mode('whiteAlpha.400', 'blackAlpha.600')(props),
		backgroundBlendMode: 'exclusion',
		backdropFilter: mode(
			'blur(46.5px) saturate(180%) brightness(1) contrast(1.33)',
		...
		_before: {
			...
			bottom: 0,
			zIndex: -1,
			background: mode('whiteAlpha.500', 'blackAlpha.400')(props),
		},
	}),
	sizes: {},
